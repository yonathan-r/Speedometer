...
public class FullCircleSpeedometerGauge extends View {
    ...
    public FullCircleSpeedometerGauge(final Context context, final AttributeSet attrs, final int defStyle) {
        super(context, attrs, defStyle);
        readAttrs(context, attrs, defStyle);
        init();
    }

    public FullCircleSpeedometerGauge(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FullCircleSpeedometerGauge(final Context context) {
        this(context, null, 0);
    }
